...
async function handleExport() {
  ...
  try {
    const className = resolveClassName(classId.value)
    downloadBlob(await downloadPersonalAchievements(classId.value), buildPersonalAchievementFilename(className))
